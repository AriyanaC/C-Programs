...
A surcharge of 2.5% is levied on the bill if the number of units consumed 
exceeds 300 units.
*******************************************************************************/
...
{
    int units; 
    float bill = 0.0 , surcharge = 0.0 , totalBill;
    
    printf("\nEnter the number of units of electricity consumed:");
    scanf("%d",&units);
